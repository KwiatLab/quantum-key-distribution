...
def check_correlations(resolution, A_B_timetags, A_B_channels,channels1,channels2,d1,d2):
...
#     print (d1/buf.resolution,d2/buf.resolution)
    ...
    check_correlations(resolution, A_B_timetags.astype(int64), A_B_channels, channels1, channels2, d1, d2)
