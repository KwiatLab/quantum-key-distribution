...
#     # print("->Channels:",bufAlice.channels)
    ...
    (aliceTtags,aliceChannels) = load_data("alice",alice_channels,10)
    (bobTtags,bobChannels) = load_data("bob",bob_channels,10)
...
#     730000
    dic = {}
#     for i in range(5100000 ,5200000,100):
#         print "\t",i,"\n"
    i =0
    dic = calculate_delays(aliceTtags.astype(uint64), aliceChannels.astype(uint8), bobTtags.astype(uint64), bobChannels.astype(uint8),i,dic,coincidence_window_radius = 1E-9) 
# #         print dic
